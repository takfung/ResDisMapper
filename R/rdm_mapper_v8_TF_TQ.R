...
#' @param disp_contours Specifies whether to display red and green contour lines that delineate genetic barriers and corridors,
#'  respectively (1), or not (0). For a further description of the meaning of a genetic barrier and a genetic corridor, please refer
#'  to the description of the function \code{rdm_resistance}. Default value of 1.
